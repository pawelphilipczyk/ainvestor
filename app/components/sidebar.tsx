							...
							{session ? (
								...
								<div class="border-t border-border pt-4">
									<a
										...
										class="group relative flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-sm font-medium text-foreground transition-colors hover:bg-accent data-[loading]:pointer-events-none data-[loading]:opacity-90"
									>
										<span class="relative z-10 flex min-w-0 flex-1 items-center gap-2 group-data-[loading]:invisible">
											<svg
