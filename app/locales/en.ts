...
/** Display labels for persisted `EtfType` values (used in guidelines UI and catalog badges). */
...
export const en = {
	...
	'guidelines.title': 'Investment Guidelines',
	'guidelines.subtitle.lead': 'Set your target allocation.',
