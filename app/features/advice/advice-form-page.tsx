...
/**
 * Advice page shell: form only. POST responses render {@link AdvicePage} with
 * room for results on the same layout width.
 */
export function AdviceFormPage(_handle: Handle, _setup?: unknown) {
	return () => (
